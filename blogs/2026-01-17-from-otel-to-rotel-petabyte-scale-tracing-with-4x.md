...
date: "2025-11-25T14:13:27.465Z"
author: "Mike Heffner, Ray Jenkins"
category: "Engineering"
excerpt: "Read how Streamfold’s Rotel pushes OpenTelemetry 4x faster into ClickHouse - benchmarking efficiency at scale and revealing the tools that make it happen"
---
...
[Watch on YouTube](https://youtube.com/watch?v=ODjPgbet-oI)

This post grew out of a talk we gave at a ClickHouse meetup in Denver. We presented our work on [Rotel](https://rotel.dev/), an OpenTelemetry data plane designed for high performance in large scale systems. 
...
Get started with the open-source observability stack, built for OpenTelemetry at scale, with just one command.

[Get Started](https://clickhouse.com/docs/use-cases/observability/clickstack/getting-started?loc=blog-cta-14-try-clickhouse-for-observability-with-clickstack-get-started&utm_blogctaid=14)
...
![rotel-pipeline-1.jpg](https://clickhouse.com/uploads/rotel_pipeline_1_04c5704b11.jpg)
...
![rotel-pipeline-2.jpg](https://clickhouse.com/uploads/rotel_pipeline_2_fa6911c37f.jpg)
...
![rotel-pipeline-3.jpg](https://clickhouse.com/uploads/rotel_pipeline_3_53cc16bc65.jpg)
...
![otel-results.png](https://clickhouse.com/uploads/otel_results_f795e64d32.png)

## Testing Rotel

### Set up

![rotel-pipeline-4.jpg](https://clickhouse.com/uploads/rotel_pipeline_4_792d48f813.jpg)
...
![rotel-results-1.png](https://clickhouse.com/uploads/rotel_results_1_9946792598.png)
...
In Rotel we use a modified version of the official Rust ClickHouse crate, <code>[clickhouse-rs](https://github.com/ClickHouse/clickhouse-rs)</code>. The `clickhouse-rs` crate uses RowBinary, a row-oriented, binary serialization format transmitted over HTTP, to write and read data from ClickHouse. In contrast, the OTel Collector’s Go driver and ClickHouse’s internal server communication use the column-oriented native protocol.
...
![row-binary-clickhouse.png](https://clickhouse.com/uploads/row_binary_clickhouse_60704c5612.png)
...
![rotel-results-2.png](https://clickhouse.com/uploads/rotel_results_2_cafed54f6b.png)
...
![rotel-process-pipe.jpg](https://clickhouse.com/uploads/rotel_process_pipe_0d20719952.jpg)
...
![rotel-results-3.png](https://clickhouse.com/uploads/rotel_results_3_6f12650fb4.png)
...
![rotel-flame-old.png](https://clickhouse.com/uploads/rotel_flame_old_ab73c122fe.png)

**New:**

![rotel-flame-new.png](https://clickhouse.com/uploads/rotel_flame_new_b96de94460.png)
...
![rotel-perf.png](https://clickhouse.com/uploads/rotel_perf_7c027ee07e.png)
...
![rotel-perf-2.png](https://clickhouse.com/uploads/rotel_perf_2_85c829c9d1.png)
...
![rotel-perf-3.png](https://clickhouse.com/uploads/rotel_perf_3_9f387c611c.png)
...
![rotel-flamegraph-3.png](https://clickhouse.com/uploads/rotel_flamegraph_3_ee3ea81bf4.png)
...
![rotel-threading-old.png](https://clickhouse.com/uploads/rotel_threading_old_208db15f08.png)
...
![rotel-threading-new.jpg](https://clickhouse.com/uploads/rotel_threading_new_8936c04ae2.jpg)
...
![rotel-results-4.png](https://clickhouse.com/uploads/rotel_results_4_045ede7829.png)
...
![rotel-results-5.png](https://clickhouse.com/uploads/rotel_results_5_300cf669ec.png)

### Visual inspection

We were able to see upwards of 3B trace spans in ClickHouse now!

![rotel-counts.png](https://clickhouse.com/uploads/rotel_counts_5d9df82333.png)
...
* Benchmark framework: https://github.com/streamfold/rotel-clickhouse-benchmark
