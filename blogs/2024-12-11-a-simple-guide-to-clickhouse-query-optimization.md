...
date: "2024-12-11T10:24:49.759Z"
author: "Lionel Palacin"
category: "Engineering"
excerpt: "A beginner-friendly guide to spotting slow ClickHouse queries and applying basic optimization tips."
---
...
![clickhouse-playground.png](https://clickhouse.com/uploads/clickhouse_playground_0600aa3c0e.png)
...
> The queries presented in this section have been executed on ClickHouse Cloud. The FROM section uses clusterAllReplicas(default, system.query_log) as the query_log table is distributed on multiple nodes in ClickHouse Cloud. Running locally, you can replace it with `FROM system.query_log`.
...
_Alternatively, ClickHouse Cloud also provides a rich UI called Query insight to display the query log through various visualizations and tables._

![cloud-query-insight.png](https://clickhouse.com/uploads/cloud_query_insight_65ba345736.png)
...
![diagram-query-optimization-1.png](https://clickhouse.com/uploads/diagram_query_optimization_1_328894ecdf.png)
...
<table>
  <thead>
    <tr>
      <th colspan="4" style="text-align: center;">Query 1</th>
    </tr>
    <tr>
      <th></th>
      <th>Run 1</th>
  ...
  <tbody>
    <tr>
      ...
      <td>1.699 sec</td>
      <td>1.353 sec</td>
      <td style="background-color: 	#023020;">0.765 sec</td>
    </tr>
    <tr>
      <td>Rows processed</td>
      <td>329.04 million</td>
      <td>329.04 million</td>
      <td style="background-color: 	#023020;">329.04 million</td>
    </tr>
    <tr>
      <td>Peak memory</td>
      <td>440.24 MiB</td>
      <td>337.12 MiB</td>
      <td style="background-color:	#023020;">444.19 MiB</td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      <th colspan="4" style="text-align: center;">Query 2</th>
    </tr>
    <tr>
      <th></th>
      <th>Run 1</th>
  ...
  <tbody>
    <tr>
      ...
      <td>1.419 sec</td>
      <td>1.171 sec</td>
      <td style="background-color:	#023020;">0.248 sec</td>
    </tr>
    <tr>
      <td>Rows processed</td>
      <td>329.04 million</td>
      <td>329.04 million</td>
      <td style="background-color: 	#023020;">41.46 million</td>
    </tr>
    <tr>
      <td>Peak memory</td>
      <td>546.75 MiB</td>
      <td>531.09 MiB</td>
      <td style="background-color: 	#023020;">173.50 MiB</td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      <th colspan="4" style="text-align: center;">Query 3</th>
    </tr>
    <tr>
      <th></th>
      <th>Run 1</th>
  ...
  <tbody>
    <tr>
      ...
      <td>1.414 sec</td>
      <td>1.188 sec</td>
      <td style="background-color: 	#023020;">0.431 sec</td>
    </tr>
    <tr>
      <td>Rows processed</td>
      <td>329.04 million</td>
      <td>329.04 million</td>
      <td style="background-color: 	#023020;">276.99 million</td>
    </tr>
    <tr>
      <td>Peak memory</td>
      <td>451.53 MiB</td>
      <td>265.05 MiB</td>
      <td style="background-color: #023020;">197.38 MiB</td>
    </tr>
  </tbody>
</table>
